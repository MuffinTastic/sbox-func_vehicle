...
public class InventoryBar : Panel
{
	...
	public override void Tick()
	{
		...
		var player = Local.Pawn as FuncVehiclePlayer;
	...
	private static void SetActiveSlot( InputBuilder input, Inventory inventory, int i )
	{
		var player = Local.Pawn as FuncVehiclePlayer;
	...
	private static void SwitchActiveSlot( InputBuilder input, Inventory inventory, int idelta )
	{
